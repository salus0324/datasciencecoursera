...
```
According to the confusionMatrix, the in sample error of the model is .... The in sample error of the cross validated model is a good estimate of the out of sample error. Since in sample error rate is quite low, I believe that prediction on the test data will have high accuracy as well.
